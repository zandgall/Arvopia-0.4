...
public abstract class Creature extends Entity {
	...
	// Sounds
	protected static Sound[] grassWalk;
	...
	public Creature(Handler handler, double x, double y, int width, int height, boolean direction, double speed,
		...
		super(handler, x, y, width, height, solid, true, false);
	...
	public static void init() {
		...
		grassWalk = new Sound[] {new Sound("Sounds/GrassWalk1.wav"), new Sound("Sounds/GrassWalk2.wav"), new Sound("Sounds/GrassWalk3.wav")};
	}
