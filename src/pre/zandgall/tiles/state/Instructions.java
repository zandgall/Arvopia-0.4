...
public class Instructions extends State{
	...
	public Instructions(Handler handler) {
		...
		back = new Button(handler, handler.getWidth()-60, handler.getHeight()-30, 55, 20, new BufferedImage[] {}, "Brings you back to the main menu", "Back");
		...
		try {
			...
			e.printStackTrace();
			instructions = new String[] {"404 File not found: There was an error trying to load the instructions :( try again later"};
		}
	}
